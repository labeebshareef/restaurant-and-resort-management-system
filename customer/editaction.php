...
$g=$_POST["password"];
$id=$_SESSION['log'];
$r="UPDATE `login` SET `username`='$c',`password`='$g',`role`='customer',`status`='1',`edit`='1' WHERE `loginid`='$id'";
...
echo "<script>alert('details updated.... !!!!');window.location='home.php' </script>"  ;
?>
