          ...
          <div class="container">
            ...
            <div class="navbar-collapse  collapse">
	         ...
	         <li ><a href="editroomspec.php">+rooms</a></li>
                 ...
                 <li class="active"><a href="viewroomspec.php">view rooms</a></li>
...
<br>
<table style="width:70%" align="center"><caption><b>CUSTOMER DETAILS</b></caption>
    <th>NAME</th>
            <th>EMAIL</th>
            <th>PHONE NO</th>
             <?php
  include './connect.php';
  $b=$_GET["id"];
  $q="SELECT * FROM `room_book` WHERE room_id='$b'";
  $r=  mysqli_query($con, $q)or die(mysqli_error($con));
  
  while($data=  mysqli_fetch_assoc($r))
  {
      $y=$data[r_user_id];
          $l="SELECT * FROM `registration` WHERE r_id='$y'";
          $m=  mysqli_query($con, $l)or die(mysqli_error($con));
  
               while($data1=  mysqli_fetch_assoc($m))
                {?>
      <tr><td><?php echo $data1['r_name'];?></td>
                <td><?php echo $data1['r_email_id'];?></td>
                <td><?php echo $data1['r_mobile_number'];?></td>
