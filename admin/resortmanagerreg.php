          ...
          <div class="container">
            ...
            <div class="navbar-collapse  collapse">
               <ul class="nav navbar-nav navbar-right scroll">
                 ...
                 <li class="active"><a href="resortmanagerreg.php">rm register</a></li>
...
<h1 align=center><b><u>RESORT MANAGER REGISTRATION</u></b></h1><br><br>
        <form method="POST" action="resortmangeraction.php">
            <table align="center">
                
                <tr>
                    <td>email</td>
                    <td><input type="email" name=email id="1" placeholder="username@gamil.com" required pattern="[A-Za-z]{3,50}"></td>
                </tr>
