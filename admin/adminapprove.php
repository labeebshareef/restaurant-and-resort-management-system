          ...
          <div class="container">
            ...
            <div class="navbar-collapse  collapse">
               <ul class="nav navbar-nav navbar-right scroll">
                 ...
                 <li class="active"><a href="adminapprove.php">approves</a></li>
...
<br>
  ...
  <?php
  include './connect.php';
  $q="SELECT * FROM registration r,login l where l.status=0 and r.r_id=l.loginid";
  ...
  ?>
            ...
            <tr><td><?php echo $data['r_name'];?></td>
                ...
                <td><a href="approve1.php?id=<?php echo $data['r_id'];?>">approve</a></td>
                <td><a href="delete.php?id=<?php echo $data['r_id'];?>">delete</a></td>
            </tr>
            <?php
  }
  ?>
