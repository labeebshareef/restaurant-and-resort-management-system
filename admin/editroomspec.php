        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="top-nav">
          <div class="container">
            ...
            <div class="navbar-collapse  collapse">
	         ...
	         <li class="active"><a href="editroomspec.php">+rooms</a></li>
...
<br><br><br><br><br><br><br><br>
        <br><br><br><br>
        <h1 align=center><b><u>ADD ROOM SPEC</u></b></h1>
        <form method="POST" action="actionroom.php">
            <table align=center>
                <tr>
                    <td>room type</td>
                    <td> <select name="roomtype" id="1">
                ...
                <tr>
                    <td>price</td>
                    <td><input type="number" name=price id="1" placeholder="price of room"></textarea></td>
                </tr>
